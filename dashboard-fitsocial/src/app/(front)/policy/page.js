...
const Policy = () => {
    return (
        <>
            <Breadcrumb title="Privacy Policy" content="At InteraxAI, we take the privacy of our users seriously" image="blog-details-vector.svg" />
                        ...
                        <div className="row">
                            <div className="col-lg-8 col-md-10 m-auto">
                                <div className="blog-main-content mt-0">
                                    <h3><img src="/assets/svg/title-effect2.svg" className="img-fluid" alt="effect" />Terms and
                                        Conditions</h3>
                                    <p>Last updated: June 16, 2023</p>
                                    <p>Please read these terms and conditions carefully before using Our Service.</p>
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" />Interpretation
                                        and Definitions</h3>
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            <p>Website refers to infoiconAI, accessible from <Link
                                                href="https://www.infoicontechnologies.com/"
                                                target="_blank">https://www.infoicontechnologies.com/</Link></p>
                                        </li>
                                        <li>
                                    ...
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" />Acknowledgment
                                    </h3>
                                    ...
                                    <p>Your access to and use of the Service is also conditioned on Your acceptance of and
                                        ...
                                        using Our Service.</p>
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" />Links to Other
                                        Websites</h3>
                                    ...
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" />Termination
                                    </h3>
                                    ...
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" />Limitation of
                                        Liability</h3>
                                    ...
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" />&quot;AS
                                    ...
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" />Governing Law
                                    </h3>
                                    ...
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" />Disputes
                                        Resolution</h3>
                                    ...
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" /><img src="/assets/svg/title-effect2.svg"
                                            className="img-fluid" alt="effect" />For European
                                        Union (EU) Users</h3>
                                    ...
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" />United States
                                        Legal Compliance</h3>
                                    <p>You represent and warrant that (i) You are not located in a country that is subject to
                                        ...
                                        any United States government list of prohibited or restricted parties.</p>
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" />Severability
                                        and Waiver</h3>
                                    <h4>Severability</h4>
                                    ...
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" />Contact Us
                                    </h3>
                                    <p>If you have any questions about these Terms and Conditions, You can contact us:</p>
                                    <ul>
                                        <li>
                                            <p>By email: infoiconAI@contact.com</p>
                                        </li>
                                        <li>
                                            <p>By visiting this page on our website: <Link
                                                href="https://www.infoicontechnologies.com/"
